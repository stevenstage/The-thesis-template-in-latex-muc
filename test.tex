...
% 封面页后设置罗马页码
\clearpage
\pagenumbering{Roman} % 从II开始
\setcounter{page}{2} % 封面页为I，摘要从II开始

\vspace*{0pt} % 消除顶部间距
\begin{center}
    \heiti \zihao{3} 摘\hspace{1em}要 % 黑体三号
\end{center}
\vspace{0.1cm} % 标题与正文间距
...
\newpage
\setcounter{page}{4} % 设置目录页为IV
\addcontentsline{toc}{section}{目录页} % 将目录页加入目录
\tableofcontents % 生成目录
\thispagestyle{fancy}
